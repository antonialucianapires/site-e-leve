...
class Parceria extends Component {
    render() {
        return (
            <section className="container-fluid" style={{ backgroundColor: "#B2DFDB", padding: "7% 2%" }}>
                <section className="container">
                    <div className="row align-items-center">
                        <div className="col-sm mr-5">
                            <img className="img-fluid" src={ParceriaImg} alt="Aperto de mão simbolizando parceria." />
                        </div>
